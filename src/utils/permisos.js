...
export const PERMISOS = {
  ...
  consultar_mora: ['asesor', 'administrador', 'riesgos', 'gerencia', 'analista', 'comite', 'operaciones', 'jefe_regional'],
  gestionar_cobranza: ['administrador', 'riesgos', 'gerencia', 'analista', 'comite', 'operaciones', 'jefe_regional'],
  derivar_judicial: ['administrador', 'riesgos', 'gerencia', 'analista', 'comite', 'operaciones', 'jefe_regional'],
  castigar_credito: ['administrador', 'riesgos', 'gerencia', 'analista', 'comite', 'operaciones', 'jefe_regional'],
...
export const UMBRAL_CASTIGO = 180 // castigo contable: >= 180 dias
